...
def fast_cd_text(batch, model, start, stop):
    ...
    W_x = weights['weight_ih_l0']  # h_dim x word_dim (512 x 300)
    W_h = weights['weight_hh_l0']  # h_dim x

    # TODO: 1. let's not resplit them.....since it's CLEARLY faster as one operation vs 4
    # TODO:    do matrix operation together, then split for individual vectors
